...
class AvbDecoderMediaFoundation : public AvbDecoderImpl {
public:
    AvbDecoderMediaFoundation();
    ~AvbDecoderMediaFoundation() override;
...
private:
    ...
    avb_result open_ivf(const char *path, const avb_decode_options &options);
    avb_result read_ivf_frame(avb_video_frame &out_frame);
